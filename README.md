...
| Project | Description |
|--------|-------------|
| [Sleepr] | 🛏️ Airbnb-style reservation system built with NestJS microservices, full-stack auth, and Stripe integration. |
| [DocumentAI](https://github.com/Adedejiosvaldo/documentai_client) | 📄 Chat with any documentation! Scrapes URLs, embeds content, and enables intelligent chat via Langchain & Gemini. |
| [Blog Microservices](https://github.com/Adedejiosvaldo/blog_microservice_node) | 📝 Blog system with Docker, Kubernetes, Nginx Ingress, and event-driven services. |
| [URL Safety Scanner] | 🛡️ Real-time phishing + malware detector using Go (Gin), Google APIs, and Redis queues. |
